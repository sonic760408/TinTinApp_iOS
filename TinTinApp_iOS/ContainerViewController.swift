...
class ContainerViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        super.viewDidLoad()
        segueIdentifierReceivedFromParent("first", nil)
    }
    
    open override func viewDidAppear(_ animated: Bool) {
        if let identifier = firstLinkedSubView{
            segueIdentifierReceivedFromParent(identifier, nil)
        }
    }
    ...
    func segueIdentifierReceivedFromParent(_ identifier: String,_ sender: AnyObject?){
